...
let giocatore1 = document.querySelector('#giocatore1'),
    giocatore2 = document.querySelector('#giocatore2'),
    numeroEstratto = document.querySelector('#numero-estratto'),
    risultato = document.querySelector('#risultato'),
    estrai = document.querySelector('#estrai');
...
function estraiNumero() {
    ...
    let resultG1 = Math.floor(Math.random() * 100 + 1),
        resultG2 = Math.floor(Math.random() * 100 + 1);
